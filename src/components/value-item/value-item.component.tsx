...
const ValueItem: FC<ValueItemProps> = ({image, imageAlt, title, number, description}) => {
    return (
        <div className='flex flex-col items-center'>
            <div className='relative'>
                <div className='relative w-[311px] h-[311px]'>
                    <Image fill src={image} alt={imageAlt} className='rounded-full'/>
            ...
            <div className='flex flex-col gap-[27px] text-center max-w-[350px] mt-[89px]'>
