...
const FmTextStack: FC<FmTextStackProps> = ({
  title,
  description,
  button,
  gap = 27,
  ...
  return (
    <div
      className="flex flex-col justify-center items-center text-center md:justify-start
    ...
    >
      ...
      {button && button.text && (
        <div>
          <FmButton onClick={button.onClick} classNames="self-baseline">
            {button.text}
          </FmButton>
        </div>
      )}
