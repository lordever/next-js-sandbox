...
const LocationsMapFooterSection = () => {
    return (
        <section className="flex flex-col lg:flex-row gap-[40px] items-center justify-center text-center md:text-left">
            ...
            <p className='text-body1 font-lexend text-dim-grey lg:w-[445px]'>If you’d like to see Scoot in your hometown, be sure to let us know. We track requests and plan launches based on demand. Feel free to message us by clicking the link or messaging us on social.</p>
