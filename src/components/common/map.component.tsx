...
import FmSpinner, {
  FmSpinnerColorKeys,
} from '@/components/common/spinner/spinner.component';
...
const FmMap = () => {
  ...
  if (loading)
    return <FmSpinner color={FmSpinnerColorKeys.YELLOW} loading={true} />;
  ...
  return (
    ...
    >
      {markers.map(({ lat, lng, name }, index) => (
        <Marker key={lat + index} longitude={lng} latitude={lat}>
